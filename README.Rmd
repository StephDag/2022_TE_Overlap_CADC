...
### Fixing link with github
  # check link with github: 
    git remote get-url origin
  # if start with https: delete the link : 
    git remote remove origin
  # create new link
    git remote add origin git@github.com:StephDag/2022_TE_Overlap_CADC.git
  # 1st comit impossible to push
